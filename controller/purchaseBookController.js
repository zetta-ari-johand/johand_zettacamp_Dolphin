...
module.exports = {
  ...
  createBook: async (req, res, next) => {
    try {
      const { bookTitle, author, price, quantity } = req.body;
      const requiredValues = ['bookTitle', 'author', 'price'];
      ...
      // data to add to db
      const bookDetail = { bookTitle, author, price, quantity, status: isAvailable };
  ...
  findBook: async (req, res, next) => {
    try {
      ...
      // find all
      // const bookData = await BookPurchaseModel.find().populate('author');
