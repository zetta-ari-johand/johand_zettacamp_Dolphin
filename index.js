...
const server = new ApolloServer({
  ...
  context: function ({ req }) {
    /**
     object shared by all the resolvers of a specific execution. 
     useful for keeping data such as authentication info, the current user, database connection, data sources and other things
     */
    return {
      bookLoader,
      authorLoader,
